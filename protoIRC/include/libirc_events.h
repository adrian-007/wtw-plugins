...
typedef struct
{
	...
	//irc_event_callback_t	event_disconnect; // adrian_007, threading stuff needs it
	//irc_event_callback_t	event_incomingData;
	//irc_event_callback_t	event_outgoingData;
     ...
     *
	 * \param origin the person, who generates the message.
	 * \param params[0] mandatory, nick/channel
