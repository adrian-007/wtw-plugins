...
inline __int64 cfgGetInt64(const wchar_t* name, __int64 def)
{
	return wtwGetInt64(wtw, config, name, def);
}
...
inline void cfgSetInt64(const wchar_t* name, __int64 value)
{
	wtwSetInt64(wtw, config, name, value);
}
