...
WTWPLUGINFO plugInfo = 
{
	...
	L"wtwAvatars",										// nazwa wtyczki
	L"Avatary lokalne",									// opis wtyczki
	__COPYRIGHTS(2009),									// prawa autorskie
	__AUTHOR_NAME,										// autor
	__AUTHOR_CONTACT,									// dane do kontaktu z autorem
	__AUTHOR_WEBSITE,									// strona www autora
	__AUTOUPDATE_URL(L"wtwAvatars.xml"),				// url do pliku xml z danymi do autoupdate
	PLUGIN_API_VERSION,									// wersja api
	MAKE_QWORD(0, 1, 1, 1),								// wersja wtyczki
	WTW_CLASS_UTILITY,									// klasa wtyczki
	0,													// f-cja wywolana podczas klikniecia "o wtyczce"
	L"{BE5884DF-1B8E-4fb0-AD48-7D19EA2A63F0}",			// guid (jezeli chcemy tylko jedna instancje wtyczki)
	0,													// zaleznosci
...
extern "C" 
{
	...
	int __stdcall pluginLoad(DWORD callReason, WTWFUNCTIONS* fC) 
	{
		...
		wtwAvatars::create(new wtwAvatars(ghInstance));
		return 0;
	}
