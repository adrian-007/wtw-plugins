...
inline int cfgSetStr(const wchar_t* name, const wchar_t* value) 
{
	return (int)wtwSetStr(wtw, config, name, value);
}

inline int cfgSetInt(const wchar_t* name, int value) 
{
	return wtwSetInt(wtw, config, name, value);
}
